...
import sys
# ╔══════════════════════════════════════════════════════════════════╗
# ║  CREATOR: ANAMUL TALUKDER 
# ║  TELEGRAN: https://t.me/BD_NatureLover
# ║  PERSONAL TELEGRAM: https://t.me/arxfflike
# ╚══════════════════════════════════════════════════════════════════╝
...
def call_api(region, uid):
    url = f"free-fire-like-api-sand.vercel.app"
    try:
